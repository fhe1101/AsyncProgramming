...
static void rt_entry_exp_timer_cbk(Timer_t *timer, void *arg) {
...
rt_insert_new_entry(rt_table_t *rt,
   ...
   if (exp_timer_in_millisec) {
        rt_table_entry->exp_timer = setup_timer(rt_entry_exp_timer_cbk,
                                                exp_timer_in_millisec,
                                                0,
                                                0,
                                                (void *)rt_table_entry,
                                                false);
   ...
   /* Now insert the new rt_table_entry at the beginning of the
    * list*/
   if(!rt->head){
...
int rt_update_rt_entry(rt_table_t *rt, char *dest, char mask, char *new_gw, char *new_oif) {
